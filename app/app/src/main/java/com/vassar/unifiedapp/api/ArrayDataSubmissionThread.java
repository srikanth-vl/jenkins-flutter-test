...
public class ArrayDataSubmissionThread extends AsyncTask<Void, Void
        , ProjectSubmissionResult> {

    private ContentValues mContentValues;
    private List<String> mMediaUUids = new ArrayList<>();
    @SuppressLint("StaticFieldLeak")
    private TabularFormActivity activity;

    public ArrayDataSubmissionThread(ContentValues contentValues, List<String> uuids, TabularFormActivity activity) {
...
//            myMap = new Gson().fromJson(additionalProps, type);
//        }
//
//        projectSubmission.setAdditionalProps(myMap);
    ...
    private void createDialog(String message, boolean shouldFinishActivity, boolean redirectToLogin) {
        ...
        // Being called after the activity is destroyed, catching that expection
        try{
            dialog.show();
        }catch (Exception e){
            e.printStackTrace();
